...
namespace TicTacToe
{
    public static class GameExtensions 
    {
        ...
        private static int Count(Dictionary<Vector2Int, EcsEntity> cells, Vector2Int position, Vector2Int direction, SignType startType, int diagonalOne, Vector2Int direction2) 
        {
